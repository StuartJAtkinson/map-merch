...
## Resolved
- [x] **Text inputs use four different paddings across the app: `.brand-select` `6px 7px`, `.save-input` `7px 9px`, `#place-search` `8px 10px`, login's `.field input` `9px 11px`. Should these collapse to one input padding, or is the size meant to track the control's importance?** — decided: a — one input size everywhere: padding 8px 10px, font-size 13px. Implement this decision. *(answered 2026-09-07)* — auto-continue *(resolved 2026-09-07)*
